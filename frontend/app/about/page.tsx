...
const zhCN: AboutCopy = {
  ...
  storyTitle: '我们的故事',
  story: [
    'ARVIX 于 2013 年在香港成立，以「让每个人都能轻松开店」为使命，致力于打造最完整的电商解决方案。',
  ...
  milestonesTitle: 'ARVIX 里程碑',
  milestones: [
    { year: '2013', desc: '在香港成立，开始提供电商解决方案' },
...
const en: AboutCopy = {
  ...
  story: [
    'Founded in Hong Kong in 2013, ARVIX set out to make launching a store simple for everyone — with a complete commerce toolkit.',
  ...
  milestones: [
    { year: '2013', desc: 'Founded in Hong Kong to deliver commerce solutions' },
